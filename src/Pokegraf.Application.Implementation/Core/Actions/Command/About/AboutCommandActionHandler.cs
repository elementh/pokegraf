...
namespace Pokegraf.Application.Implementation.Core.Actions.Command.About
{
    public class AboutCommandActionHandler : IRequestHandler<AboutCommandAction, Status<Error>>
    {
        ...
        {
            const string aboutText = @"[pokegraf](https://github.com/elementh/pokegraf) is a bot made with ❤️ by [Lucas Maximiliano Marino](http://lucasmarino.me/) with the help of [contributors](https://github.com/elementh/pokegraf/blob/master/CONTRIBUTORS.md)!.  
