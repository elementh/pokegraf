...
{
    public class PokemonPreviousCallbackAction : CallbackQueryAction
    {
        public Dictionary<string, string> ParsedData { get; set; }

        public PokemonPreviousCallbackAction()
        {
        ...
        {
            return ParsedData.TryGetValue("action", out var action) && action == "pokemon_previous";
        }
    }
}